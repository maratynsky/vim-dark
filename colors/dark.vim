...
highlight Normal                     term=NONE      cterm=NONE      ctermbg=16  ctermfg=7    gui=NONE      guibg=#000000  guifg=#EEEEEE

highlight ColorColumn                term=NONE      cterm=NONE      ctermbg=88  ctermfg=7    gui=NONE      guibg=DarkRed  guifg=#EEEEEE
highlight Comment                    term=NONE      cterm=NONE      ctermbg=16  ctermfg=0    gui=italic    guibg=#000000  guifg=#4E4E4E
highlight Conceal                    term=NONE      cterm=NONE      ctermbg=248 ctermfg=252  gui=NONE      guibg=DarkGrey guifg=LightGrey
highlight Conditional                term=bold      cterm=bold      ctermbg=16  ctermfg=68   gui=bold      guibg=#000000  guifg=#6D90D1
...
highlight Directory                  term=NONE      cterm=NONE      ctermbg=16  ctermfg=51   gui=NONE      guibg=#000000  guifg=Cyan
highlight Error                      term=undercurl cterm=undercurl ctermbg=16  ctermfg=7    gui=undercurl guibg=#000000  guifg=#EEEEEE
highlight ErrorMsg                   term=NONE      cterm=NONE      ctermbg=203 ctermfg=16   gui=NONE      guibg=#FF6C60  guifg=#000000
highlight FoldColumn                 term=NONE      cterm=NONE      ctermbg=16  ctermfg=7    gui=NONE      guibg=#000000  guifg=#EEEEEE
highlight Folded                     term=NONE      cterm=NONE      ctermbg=16  ctermfg=7    gui=NONE      guibg=#000000  guifg=#EEEEEE
highlight Function                   term=NONE      cterm=NONE      ctermbg=16  ctermfg=223  gui=NONE      guibg=#000000  guifg=#FFD2A7
highlight GitGutterAddDefault        term=NONE      cterm=NONE      ctermbg=16  ctermfg=28   gui=NONE      guibg=#000000  guifg=#009900
highlight GitGutterAddInvisible      term=NONE      cterm=NONE      ctermbg=16  ctermfg=16   gui=NONE      guibg=#000000  guifg=0
highlight GitGutterChangeDefault     term=NONE      cterm=NONE      ctermbg=16  ctermfg=142  gui=NONE      guibg=#000000  guifg=#bbbb00
highlight GitGutterChangeInvisble    term=NONE      cterm=NONE      ctermbg=16  ctermfg=7    gui=NONE      guibg=#000000  guifg=#EEEEEE
highlight GitGutterChangeInvisible   term=NONE      cterm=NONE      ctermbg=16  ctermfg=16   gui=NONE      guibg=#000000  guifg=0
highlight GitGutterChangeLineDefault term=bold      cterm=bold      ctermbg=233 ctermfg=7    gui=bold      guibg=#121212  guifg=#EEEEEE
highlight GitGutterDeleteDefault     term=NONE      cterm=NONE      ctermbg=16  ctermfg=196  gui=NONE      guibg=#000000  guifg=#ff2222
highlight GitGutterDeleteInvisible   term=NONE      cterm=NONE      ctermbg=16  ctermfg=16   gui=NONE      guibg=#000000  guifg=0
highlight Identifier                 term=NONE      cterm=NONE      ctermbg=16  ctermfg=189  gui=NONE      guibg=#000000  guifg=#D3C4F7
highlight Ignore                     term=NONE      cterm=NONE      ctermbg=16  ctermfg=250  gui=NONE      guibg=Black    guifg=gray
highlight IncSearch                  term=reverse   cterm=reverse   ctermbg=16  ctermfg=7    gui=reverse   guibg=#000000  guifg=#EEEEEE
highlight Keyword                    term=bold      cterm=bold      ctermbg=16  ctermfg=117  gui=bold      guibg=#000000  guifg=#8FC4FD
highlight LineNr                     term=NONE      cterm=NONE      ctermbg=16  ctermfg=59   gui=NONE      guibg=#000000  guifg=#484E52
highlight MatchParen                 term=NONE      cterm=NONE      ctermbg=111 ctermfg=233  gui=NONE      guibg=#7DBFFE  guifg=#151616
highlight ModeMsg                    term=NONE      cterm=NONE      ctermbg=155 ctermfg=233  gui=NONE      guibg=#C1F360  guifg=#151616
highlight MoreMsg                    term=bold      cterm=bold      ctermbg=16  ctermfg=29   gui=bold      guibg=#000000  guifg=SeaGreen
highlight NonText                    term=NONE      cterm=NONE      ctermbg=16  ctermfg=59   gui=NONE      guibg=#000000  guifg=#484E52
highlight Number                     term=NONE      cterm=NONE      ctermbg=16  ctermfg=13   gui=NONE      guibg=#000000  guifg=#FF9CFE
highlight Operator                   term=NONE      cterm=NONE      ctermbg=16  ctermfg=68   gui=NONE      guibg=#000000  guifg=#6D90D1
...
highlight SpellCap                   term=undercurl cterm=undercurl ctermbg=16  ctermfg=7    gui=undercurl guibg=#000000  guifg=#EEEEEE
highlight SpellLocal                 term=undercurl cterm=undercurl ctermbg=16  ctermfg=7    gui=undercurl guibg=#000000  guifg=#EEEEEE
highlight SpellRare                  term=undercurl cterm=undercurl ctermbg=16  ctermfg=7    gui=undercurl guibg=#000000  guifg=#EEEEEE
highlight Statement                  term=NONE      cterm=NONE      ctermbg=16  ctermfg=68   gui=NONE      guibg=#000000  guifg=#6D90D1
...
highlight TermCursor                 term=reverse   cterm=reverse   ctermbg=16  ctermfg=7    gui=reverse   guibg=#000000  guifg=#EEEEEE
highlight TermCursorNC               term=NONE      cterm=NONE      ctermbg=16  ctermfg=7    gui=NONE      guibg=#000000  guifg=#EEEEEE
highlight Title                      term=bold      cterm=bold      ctermbg=16  ctermfg=229  gui=bold      guibg=#000000  guifg=#FFFFB6
highlight Todo                       term=NONE      cterm=NONE      ctermbg=16  ctermfg=245  gui=NONE      guibg=#000000  guifg=#8F8F8F
highlight Type                       term=NONE      cterm=NONE      ctermbg=16  ctermfg=229  gui=NONE      guibg=#000000  guifg=#FFFFB6
highlight Underlined                 term=underline cterm=underline ctermbg=16  ctermfg=111  gui=underline guibg=#000000  guifg=#80a0ff
highlight User1                      term=NONE      cterm=NONE      ctermbg=235 ctermfg=8    gui=NONE      guibg=#222324  guifg=#E6EEF5
highlight User2                      term=NONE      cterm=NONE      ctermbg=235 ctermfg=146  gui=NONE      guibg=#222324  guifg=#B8C2CC
highlight User3                      term=NONE      cterm=NONE      ctermbg=235 ctermfg=226  gui=NONE      guibg=#222324  guifg=yellow
highlight VertSplit                  term=NONE      cterm=NONE      ctermbg=16  ctermfg=16   gui=NONE      guibg=#000000  guifg=#000000
